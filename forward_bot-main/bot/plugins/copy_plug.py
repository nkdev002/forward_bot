...
async def copy(client, message):
    ...
    try:
        ...
        cursor.execute(
            "INSERT INTO copy (mode, from_chat, from_chat_name, to_chat, to_chat_name, start, current, stop) "
            "VALUES (?, ?, ?, ?, ?, ?, ?, ?)",
            (mode, from_chat, from_chat_name, to_chat, to_chat_name, start, current, stop)
        )
        db.commit()
